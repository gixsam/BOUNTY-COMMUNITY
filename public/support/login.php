...
<head>
    ...
    <title>Customer Support & Escrow Dispute Desk | <?= htmlspecialchars(COMMUNITY_NAME) ?></title>
    <style>
    ...
    <div class="w-full max-w-md relative z-10 my-8">
        ...
        <div class="text-center mb-6">
            ...
            <div class="inline-block mb-2">
                <span class="text-xs font-mono uppercase px-3 py-1 rounded-full bg-teal-500/10 text-teal-400 border border-teal-500/20 font-bold">
                    Staff Desk Terminal
                </span>
            </div>

            <h1 class="text-xl font-bold text-white tracking-tight">
                Customer Support & Escrow Dispute Desk
            </h1>
            <p class="text-xs text-slate-400 mt-1 font-mono">
                Dispute Mediation, Ticket Queues & Escrow Refunds
            </p>
        </div>
        ...
        <!-- Login Form Card -->
        <div class="glass-card bg-[#121826]/88 backdrop-blur-2xl border border-teal-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl relative">
